...
AI_PATTERNS = [
    # GitHub Copilot (multiple formats)
    "copilot@github.com",
    ...
    "aider",
    # Generic patterns various tools use
    "generated by ai",
    "ai-generated",
]
# ---------------------------------------------------------------------------
...
# --- active devs + AI-assisted detection (from 7d commits) ---
    authors = set()
    ai_assisted_count = 0
    if isinstance(commits7, list):
        for item in commits7:
            ...
            # Check commit message for AI tool patterns
...
# --- write snapshot ---
    with SessionLocal() as session:
        ...
        metrics = {
            ...
            "ai_assisted_commits": ai_assisted_count,
        }
...
async def org_dashboard(org_id: str, spark_points: int = 20) -> dict:
    ...
    with SessionLocal() as session:
        ...
        for tr in tracked:
            ...
            ai_c = metrics.get("ai_assisted_commits", 0)
            if isinstance(ai_c, int):
                ai_assisted_total += ai_c
